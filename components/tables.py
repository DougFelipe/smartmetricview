...
from dash import html  # Importando html para usar no wrapper

def create_table_from_dataframe(df: pd.DataFrame, table_id: str, hidden_columns: list = None) -> html.Div:
    """
    ...
    return html.Div(children=[table], className='table-container')
